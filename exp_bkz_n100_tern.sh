...
# Per-job output file
perjob_out=./data/n100/tern/bkz${blocksize}_t${tours}_trial${trial}.txt

# Shared output file
shared_out=./data/n100/tern/bkz${blocksize}_t${tours}_all.txt
touch "${shared_out}"
lock_file=./data/n100/tern/bkz${blocksize}_t${tours}.lock
touch "${lock_file}"

# Run experiment
python3 -u primalattack.py n=100 m=104 q=257 dist=Ternary\(\) \

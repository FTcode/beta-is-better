...
# Per-job output file
perjob_out=./data/n93/cbin/bkz${blocksize}_t${tours}_trial${trial}.txt

# Shared output file
shared_out=./data/n93/cbin/bkz${blocksize}_t${tours}_all.txt
touch "${shared_out}"
lock_file=./data/n93/cbin/bkz${blocksize}_t${tours}.lock
touch "${lock_file}"
